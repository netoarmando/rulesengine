...
class SurtTestCase(unittest.TestCase):
    ...
    def test_domain_and_path(self):
        ...
        self.assertEqual(surt.parts, ["https://(", "org,", "archive,", ")", "/about"])
        surt = Surt.from_url("https://archive.org/about/bios.php")
        self.assertEqual(
            surt.parts, ["https://(", "org,", "archive,", ")", "/about", "/bios.php"]
        )
    ...
    def test_domain_and_query(self):
        ...
        self.assertEqual(
            surt.parts, ["https://(", "com,", "example,", ")", "?first=rose&last=tyler"]
        )
    ...
    def test_domain_path_query_and_hash(self):
        surt = Surt.from_url("https://example.com/doctor/companion?name=rose#actress")
        self.assertEqual(
            surt.parts,
            [
                "https://(",
